...
- **Interface members**: generic methods (`U Map<U>()`), `ref` returns and `static abstract` members can't be adapted for types that don't implement the interface ([`IFITQUACKS005`](diagnostics.md#ifitquacks005)).
