...
- **Containing type**: the containing type has to be `partial` ([`IFITQUACKS002`](diagnostics.md#ifitquacks002)) and non-generic. Extension methods are not supported ([`IFITQUACKS004`](diagnostics.md#ifitquacks004)).
